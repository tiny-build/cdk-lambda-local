...
- 🛡️ **Authorizers per route** — invoked exactly like API Gateway does.
...
3. ⚙️ **Prompt** for stage, log level, and log output (stdout vs file).
4. 📦 **Install** `cdk-local-lambda` as a dev dependency using your detected package manager (npm / pnpm / yarn / bun).
5. 🏗️ **Run `cdk synth`** and extract the manifest to `.cdk-local/manifest.json`.
